  ...
  <div class="header-right">
    ...
    <%
        try{
        	...
        	ResultSet rs=stmt.executeQuery("select * from applicantsignup where APP_USERNAME='"+Username+"' && APP_CONTACT='"+Contact+"'");
      %>
...
%>
     ...
     <div class="w3-card-4 w3-center" style="max-width:400px padding-left:300px">
        <br><div class="imgcontainer">
          <br><img src="images\img13.png" alt="Avatar" class="avatar">
        </div><br>
